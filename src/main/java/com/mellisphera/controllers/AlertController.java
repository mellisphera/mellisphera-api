...
public class AlertController {
	...
	public List<Alert> getHiveAlert(@PathVariable String idHive, @RequestBody Date[] range) {
		return this.alertRepository.findByIdHiveAndDateBetween(idHive, range[0], range[1]).stream().filter(_alert -> _alert.getLoc().equals("Hive")).collect(Collectors.toList());
	}
